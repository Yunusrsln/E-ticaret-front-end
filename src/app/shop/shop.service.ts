...
export class ShopService {
  ...
  baseUrl = "http://192.168.85.237:7054/api/";
  ...
  getproducts(shopParams: ShopParams){
    ...
    return this.httpClient.get<IPagination>(this.baseUrl + 'GetProducts',{observe :'response',params})
    .pipe(
      map(response => {
  ...
  getTypes(){
    return this.httpClient.get<IType[]>(this.baseUrl+'Products/GetProducTypes');
  }
